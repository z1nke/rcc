...
int main() {
  ...
  // [37] Add octal escape sequence
  ASSERT(0, "\0"[0]);
  ASSERT(16, "\20"[0]);
  ASSERT(65, "\101"[0]);
  ASSERT(104, "\1500"[0]);

  // [38] Add hexadecimal escape sequence
  ASSERT(0, "\x00"[0]);
  ASSERT(119, "\x77"[0]);

  // [193] Concatenate adjacent string literals
  ...
  // [237] Allow to concatenate regular string literals with L/u/U string literals
