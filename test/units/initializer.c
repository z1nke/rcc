...
// [105] Add global initializer for scalar and string
char g3 = 3;
short g4 = 4;
int g5 = 5;
long g6 = 6;

// [106] Add struct initializer for global variable
int g9[3] = {0, 1, 2};
...
// [108] Allow parentheses in initializers to be omitted
...
// [243] Add union designated initializer
...
int main() {
  ...
  // [100] Add string literal initializer
  ...
  // [101] Allow to omit array length if an initializer is given
  ...
  // [102] Handle struct initializers for local variables
  ...
  // [103] Allow to initialize a struct with other struct
  ASSERT(1, ({ typedef struct {int a,b;} T; T x={1,2}; T y=x; y.a; }));

  // [104] Handle union initializers for local variables
  ...
  // [239] Add array designated initializer
  ...
  // [240] Allow array designators to initialize incomplete arrays
  ...
  // [241] [GNU] Allow to omit "=" in designated initializers
  ASSERT(7, ((int[10]){ [3] 7 })[3]);
  ASSERT(0, ((int[10]){ [3] 7 })[4]);

  // [242] Add struct designated initializer
  ...
  // [244] Handle struct designator for anonymous struct member
